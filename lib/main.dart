...
// import 'modules/auth/signup/presentation/view/login_screen.dart'; // Import AppTheme
//
// void main() async {
...
import 'core/responsive/responsive.dart';
import 'core/responsive/scale_config.dart';
import 'modules/auth/auth_call_back.dart';
import 'modules/auth/login/presentation/view/login_screen.dart';
import 'modules/home/presentation/view/home_tablet_view.dart';
    ...
    return ScreenUtilInit(
      ...
      builder: (context, child) {
        ...
        return MaterialApp(
          ...
          // Corrected the case of the class name
          //SignUpScreen(),
        );
      },
    );
