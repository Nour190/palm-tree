...
class IthraArtistsSection extends StatelessWidget {
  ...
  Widget _buildArtistsGrid(BuildContext context, DeviceType deviceType) {
    ...
    return SizedBox(
      height: isMobile ? 140.sH : isTablet ? 160.sH : 180.sH,
      child: ListView.separated(
        scrollDirection: Axis.horizontal,
        itemCount: displayArtists.length,
        separatorBuilder: (context, index) => SizedBox(width: isMobile ? 16.sW : 20.sW),
...
class _IthraArtistCardState extends State<_IthraArtistCard>
  ...
  Widget build(BuildContext context) {
    ...
    final double avatarSize = isMobile ? 70.sW : isTablet ? 85.sW : 100.sW;
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          ...
                          style: TextStyle(
                            fontFamily: 'Inter',
                            fontSize: isMobile ? 11.sSp : isTablet ? 12.sSp : 13.sSp,
                        ...
                        //   style: TextStyle(
                        //     fontFamily: 'Inter',
                        //     fontSize: isMobile ? 9.sSp : isTablet ? 10.sSp : 11.sSp,
