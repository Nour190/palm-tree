// chat_tab.dart
// Artwork-as-speaker (Gemini persona) + Text→Audio via flutter_tts
// + Audio→Text prompt via record (PCM->WAV) to Gemini (NO transcript shown)
// + Supabase persistence through ChatCubit/Repository (audio stored as TEXT placeholders)
// + Five-language TTS selector (EN, AR, FR, ES, ZH) using translator 1.0.4+1 for speak-only translation (handled in Cubit)
